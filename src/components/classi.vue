  ...
  <div>
      ...
      <div class="ws_main">
          <ul class="sidebar_left">
            <router-link v-for="data,index in data_list" :to="'/classi_child'+wsroute_list[index]"  tag="li" activeClass="active">{{data.gc_name}}</router-link>
          </ul>
          <!--  -->
...
export default {
  ...
  data () {
    ...
    product_list:[{name:'dianqi',id:256},{}],
    who:'',
